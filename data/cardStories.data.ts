...
const dataNagisa: D = {
  ...
  'card-ngs-05-akma-00': {
    // いたずら好きな小悪魔
    // 名场面之二 琴乃：？？？
    1: { name: 'TODO', video: { type: 'bilibili', vid: 'av424455150' } },
    2: { name: 'TODO', video: { type: 'bilibili', vid: 'av424429682' } },
...
const dataSaki: D = {
  ...
  'card-ski-05-waso-00': {
    ...
    2: { name: '贯彻自我', video: { type: 'bilibili', vid: 'av210788482' } },
    3: {
      name: '真的非常，最喜欢',
...
const dataMei: D = {
  ...
  'card-mei-05-fest-00': {
    // 一人のアイドルとの出会い
    1: { name: 'TODO', video: { type: 'bilibili', vid: 'av767697149' } },
...
const dataChisa: D = {
  ...
  'card-chs-05-rock-00': {
    // ひと握りの勇気
    1: { name: 'TODO', video: { type: 'bilibili', vid: 'av724155740' } },
    2: { name: 'TODO', video: { type: 'bilibili', vid: 'av509207271' } },
    3: { name: 'TODO', video: { type: 'bilibili', vid: 'av381667896' } },
  },
  'card-chs-05-chsk-00': {
    // 絆溢れるクリエーション
    1: {
...
const dataHaruka: D = {
  ...
  'card-hrk-05-chna-00': {
    ...
    2: { name: '释放吧', video: { type: 'bilibili', vid: 'av725033621' } },
    3: {
      name: '万众瞩目的一刻',
      video: { type: 'bilibili', vid: 'av895030224' },
    },
    phone: { video: { type: 'bilibili', vid: 'av595085113' } },
  },
  'card-hrk-05-idol-03': {
    // 私、決めたよ
    1: {
...
const dataRui: D = {
  ...
  'card-rui-05-xmas-00': {
    ...
    phone: { video: { type: 'bilibili', vid: 'av464607750' } },
  },
  'card-rui-05-date-00': {
    // 緑風誘うデートスポット
    1: {
...
const dataYu: D = {
  ...
  'card-yu-05-mizg-01': {
    // 秘密のフォトセッション
    1: { name: 'TODO', video: { type: 'bilibili', vid: 'av206687488' } },
    2: { name: 'TODO', video: { type: 'bilibili', vid: 'av206687488' } },
    3: { name: 'TODO', video: { type: 'bilibili', vid: 'av206687488' } },
  },
  'card-yu-05-xmas-00': {
    // うちらのクリスマスイブ
    1: { name: 'TODO', video: { type: 'bilibili', vid: 'av294899075' } },
...
const dataSumire: D = {
  ...
  'card-smr-05-xmas-00': {
    ...
    phone: { video: { type: 'bilibili', vid: 'av464939209' } },
  },
  'card-smr-05-frut-00': {
    // Little lover
    1: {
...
const dataRio: D = {
  ...
  'card-rio-05-kait-00': {
    // 憧憬のアクター
    1: { name: '挑战宣告', video: { type: 'bilibili', vid: 'av682892551' } },
    2: {
      name: '心中的石子与无法传达的话语',
...
const dataAi: D = {
  ...
  'card-ai-05-tact-00': {
    ...
    2: { name: '全军突击', video: { type: 'bilibili', vid: 'av811823258' } },
    3: {
      name: '为了谁而努力',
...
const dataKokoro: D = {
  ...
  'card-kkr-05-seik-00': {
    // 私は私
    1: { name: 'TODO', video: { type: 'bilibili', vid: 'av805887097' } },
    2: { name: 'TODO', video: { type: 'bilibili', vid: 'av763400456' } },
    3: { name: 'TODO', video: { type: 'bilibili', vid: 'av420988923' } },
  },
  'card-kkr-05-vlnt-00': {
    // ビタースイートメモリーズ
    1: {
